...
#define NPARAMS              2
/* Parameter  1 */
#define PARAMETER_0_NAME      i2cAddress
...
extern void Tmp102_Outputs_wrapper(real_T *Temp ,
			      const real_T  *xD,
                          const int8_T  *i2cAddress, const int_T  p_width0, 
                          const real_T  *sampleTime, const int_T p_width1);
extern void Tmp102_Update_wrapper(const real_T *Temp ,
                          real_T *xD, 
                          const int8_T  *i2cAddress,  const int_T  p_width0,
                           const real_T *sampleTime, const int_T  p_width1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Tmp102_Outputs_wrapper(Temp, xD, i2cAddress, p_width0, sampleTime, p_width1);
}
