...
/* Output Port  0 */
#define OUT_PORT_0_NAME      Humidity
...
#define NPARAMS              2
/* Parameter  1 */
#define PARAMETER_0_NAME      interruptNum
...
#define SOURCEFILES "__SFB__SRC_PATH $FUNARDUINO__SFB__INC_PATH $FUNARDUINO"
#define PANELINDEX           6
...
extern void HH10D_Outputs_wrapper(real_T *Humidity ,
			      const real_T  *xD,
                          const int8_T  *interruptNum, const int_T  p_width0, 
                          const real_T  *sampleTime, const int_T p_width1);
extern void HH10D_Update_wrapper(const real_T *Humidity ,
                          real_T *xD, 
                          const int8_T  *interruptNum,  const int_T  p_width0,
                           const real_T *sampleTime, const int_T  p_width1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    HH10D_Outputs_wrapper(Humidity, xD, interruptNum, p_width0, sampleTime, p_width1);
}
