...
void indexCmd(WebServer &server, WebServer::ConnectionType type, char *command, bool)
{
  ...
  if (type == WebServer::HEAD)
  {
    ...
    sendStringInSRAM(server,PSTR("document.getElementById(\"switch_txt\").innerHTML = this.responseText;"));
    ...
    sendStringInSRAM(server,PSTR("<p id=\"switch_txt\">Temperature: Not requested...</p>"));
