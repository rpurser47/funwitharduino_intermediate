...
void loop()
{
  ...
  boolean connected;
  connected = !!! insert your code using client.connect here to connect to api.thingspeak.com on port 80 (HTTP)
  ...
  // Request/GET the page we want (/channels/1417/field/1/last.txt) using client.println  
  // Rememeber that HTTP protocol is "GET <full page path>"
  !!! Your code here
